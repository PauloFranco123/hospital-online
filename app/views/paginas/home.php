...
<section id="home" >
    <div class="wrapper">
            ...
            <?= Sessao::mensagem('usuario')?>
                ...
                <div class="content">
                    <p>
                        Os médicos da DoctorCare vão além dos sintomas para tratar a causa da sua doença e proporcionar uma cura a longo prazo.
                    </p>
            ...
            <div class="col-b">
                ...
                <img class="mulher" src="<?=URL?>/public/assets/image.png" alt="Mulher negra sorrindo ">
            </div>
