...
<?= Sessao::mensagem('perfil')?>
    <section id="contact">
        <div class="wrapper">
            <div class="col-a">
                <header>
                <h2>Entre em contacto com a gente!</h2> 
                </header>
                <div class="content">
                    <ul>
                    ...
                    </svg>contacto@doctorcare.com</li>
                    </ul>

                    <a class="button" href="<?=URL?>/consultas/cadastrar" target="_blank">
            ...
            <img src="<?=URL?>/public/assets/man.png" alt="homem negro com moletom bege mexendo no celular e sorrindo">
            </div>
        </div>
    </section>